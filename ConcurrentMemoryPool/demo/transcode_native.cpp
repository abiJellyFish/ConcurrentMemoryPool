...
int main(int argc, char* argv[]) {
    ...
    // ★ 原生版本：使用标准 av_frame_get_buffer 分配
    ...
    if (av_frame_get_buffer(enc_frame, 0) < 0) {
        fprintf(stderr, "Could not allocate encode frame buffer\n");
    ...
    printf("Transcoding completed successfully! (native malloc)\n");
    return 0;
}
